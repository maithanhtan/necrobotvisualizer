            ...
            var pkm = Array.from(msg.PokemonList.$values, p => {
                var pkmInfo = global.pokemonSettings[p.Item1.PokemonId - 1];
                 return {
                    ...
                    maxCpCurrent: Utils.CalculateMaxCpCurrentLvl(p.Item1),
                    maxCpMax: Utils.CalculateMaxCpMaxLvl(p.Item1),
                    perfectCpMax: Utils.CalculatePerfectCpMaxLvl(p.Item1),
					...
					maxLevelItems: Utils.CalculateMaxLevelItems(p.Item1)
                }
            });            
